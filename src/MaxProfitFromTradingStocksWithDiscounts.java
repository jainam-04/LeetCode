...
public class MaxProfitFromTradingStocksWithDiscounts {
    int B;
    List<Integer>[] tree;
    int[] present, future;
    int[][][] dp;
    ...
    public static void main(String[] args) {
        ...
        int budget = 3;
        MaxProfitFromTradingStocksWithDiscounts maxProfitFromTradingStocksWithDiscounts = new MaxProfitFromTradingStocksWithDiscounts();
        int result = maxProfitFromTradingStocksWithDiscounts.maxProfit(n, present, future, hierarchy, budget);
